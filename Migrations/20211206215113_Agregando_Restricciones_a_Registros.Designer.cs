...
namespace ProyectoFinal_ContratacionEmpleados.Migrations
{
    ...
    [Migration("20211206215113_Agregando_Restricciones_a_Registros")]
    partial class Agregando_Restricciones_a_Registros
    {
            ...
            modelBuilder.Entity("ProyectoFinal_ContratacionEmpleados.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistroUsuario = new DateTime(2021, 12, 6, 17, 51, 10, 483, DateTimeKind.Local).AddTicks(4078),
                            NombreUsuario = "Admin",
                            RolId = 1
                        });
                });
