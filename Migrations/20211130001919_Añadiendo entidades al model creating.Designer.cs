...
namespace ProyectoFinal_ContratacionEmpleados.Migrations
{
    ...
    [Migration("20211130001919_Añadiendo entidades al model creating")]
    partial class Añadiendoentidadesalmodelcreating
    {
            ...
            modelBuilder.Entity("ProyectoFinal_ContratacionEmpleados.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistroUsuario = new DateTime(2021, 11, 29, 20, 19, 17, 463, DateTimeKind.Local).AddTicks(5206),
                            NombreUsuario = "Admin",
                            RolId = 1
                        });
                });
