...
namespace ProyectoFinal_ContratacionEmpleados.Migrations
{
    ...
    [Migration("20211127015338_Modificando entidad Empresas")]
    partial class ModificandoentidadEmpresas
    {
            ...
            modelBuilder.Entity("ProyectoFinal_ContratacionEmpleados.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistroUsuario = new DateTime(2021, 11, 26, 21, 53, 36, 209, DateTimeKind.Local).AddTicks(2456),
                            NombreUsuario = "Admin"
                        });
                });
