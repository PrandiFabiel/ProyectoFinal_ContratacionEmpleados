...
namespace ProyectoFinal_ContratacionEmpleados.Migrations
{
    ...
    [Migration("20211127214222_Modificando entidad Empresas segunda vez")]
    partial class ModificandoentidadEmpresassegundavez
    {
            ...
            modelBuilder.Entity("ProyectoFinal_ContratacionEmpleados.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistroUsuario = new DateTime(2021, 11, 27, 17, 42, 20, 889, DateTimeKind.Local).AddTicks(8654),
                            NombreUsuario = "Admin"
                        });
                });
