...
namespace ProyectoFinal_ContratacionEmpleados.Migrations
{
    ...
    [Migration("20211122225754_Cambiando_nombre_variable")]
    partial class Cambiando_nombre_variable
    {
            ...
            modelBuilder.Entity("ProyectoFinal_ContratacionEmpleados.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistroUsuario = new DateTime(2021, 11, 22, 18, 57, 52, 639, DateTimeKind.Local).AddTicks(8237),
                            NombreUsuario = "Admin"
                        });
                });
